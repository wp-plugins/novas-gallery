...
foreach($results as $results) {
	echo '<div class="album-photo" id="local-'.$results->id.'"><div class="gallery-photo" style="background:url('.$results->url.');"></div><a href="#" imageid="'.$results->id.'" class="local-delete">Remove</a></div>';
}
echo '</tr></div></div>';
?>